...
class _OrderHistoryState extends State<OrderHistory> {
  ...
  getCustomerInformation() async{
    ...
    return await firestoreInstance.collection("Operators").doc('02012001'/*firebaseUser!.uid*/).get().then((value){
      setState(() {
        customerName = value.data()!["Customer Name"];
        orderNo = value.data()!["Order No"];
        if(value.data()!["Customer Name"]!= null || value.data()!["Order No"]!= null){
          loading = false;
        }
      });
    });
  ...
  getProductInformation(){
    ...
    firestoreInstance.collection("cart").doc('12345'/*firebaseUser!.uid*/).get().then((value){
      setState(() {
        ...
        if(value.data()!["Product Price"]!= null)
          loading = false;
      });
    });
  }
